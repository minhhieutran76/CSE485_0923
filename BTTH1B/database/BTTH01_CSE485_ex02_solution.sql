...
select * from tacgia join baiviet on tacgia.ma_tgia = baiviet.ma_tgia;

SELECT COUNT(*) FROM theloai WHERE ten_tloai = :theloai;

select * from baiviet join tacgia on baiviet.ma_tgia = tacgia.ma_tgia join theloai on baiviet.ma_tloai = theloai.ma_tloai